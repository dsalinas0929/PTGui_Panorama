...
DEFAULT_TEMPLATE = SCRIPT_DIR / "NORD.pts"
DEFAULT_DATASET_DIR = SCRIPT_DIR / "dataset" / "TEST_NORD"
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Create PTGui projects from LEFT/RIGHT image pairs using NORD.pts as a template, "
